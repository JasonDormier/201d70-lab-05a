...
function sumArray(sumArr) { //eslint-disable-line
  ...
  var message = `${testArray} was passed in as an array of numbers, and ${sumOfNumbers} is their sum.`

  return [sumOfNumbers, message]
}
...
function multiplyArray(multArr) { //eslint-disable-line
  ...
  for (var i = 0; i < testArray.length; i++) {
    productOfNumbers *= testArray[i];
  }
  //console.log(productOfNumbers);

  var anotherMessage = `The numbers ${testArray} have a product of ${productOfNumbers}.`
  return [productOfNumbers, anotherMessage];
}
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
  ...
  for (var i = 0; i < testDynamicArray.length; i++) {
    productOfNumbers *= testDynamicArray[i];
  }
  //console.log(productOfNumbers);

  var anotherMessage = `The numbers ${testDynamicArray} have a product of ${productOfNumbers}.`
  return [productOfNumbers, anotherMessage];
}
